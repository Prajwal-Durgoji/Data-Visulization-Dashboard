...
class UsersMonthUsage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            res: {
    ...
    fetchData = date => {
        // var selectedDate = (parseInt(date.getMonth()) + parseInt(1)) + '/' + date.getFullYear();
        var selectedDate = date.getFullYear() + '-' + (date.getMonth() + 1).toString().padStart(2, '0');
        ...
        // fetch('https://basavahealing.org/api/users/getUsageByMonth/' + selectedMonth, requestOptions)
        fetch('http://localhost:8080/api/auth/userData/month/' + selectedDate, requestOptions)
            .then(async response => {
                    ...
                    <div>
                        ...
                        <HorizontalBar
                            ...
                            options={{
                                title: {
                                    display: true,
                                    text: 'Pulse Usage by Each User on ' + (parseInt(this.state.startDate.getMonth()) + parseInt(1)) + '/' + this.state.startDate.getFullYear(),
                                    fontSize: 20
                                },
                                scales: {
                                    yAxes: [{
...
export default UsersMonthUsage;